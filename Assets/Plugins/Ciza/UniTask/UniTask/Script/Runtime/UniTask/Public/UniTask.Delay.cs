...
namespace CizaUniTask
{
	public readonly partial struct UniTask
	{
		...
		public static UniTask Delay(int millisecondsDelay, bool ignoreTimeScale = false, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken cancellationToken = default)
		{
			...
			return ignoreTimeScale ? new DelayIgnoreTimeScalePromise(delayTimeSpan, delayTiming, cancellationToken).Task : new DelayPromise(delayTimeSpan, delayTiming, cancellationToken).Task;
		}
